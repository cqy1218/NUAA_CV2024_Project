...
class RegularDatapipeline(DatapipelineBase):
    ...
    def __getitem__(self, item) -> Dict:
        ...
        #     bbox_z_b = sampled_data['data1']['anno_{}'.format(i)][:4].astype(np.int32).tolist()
        ...
        # bbox_x_b = sampled_data['data2']['anno'][:4].astype(np.int32).tolist()
        ...
        #     bbox_z = sampled_data['bbox_z'][i].astype(np.int32).tolist()
        ...
        # bbox_x = sampled_data['bbox_x'][:4].astype(np.int32).tolist()
