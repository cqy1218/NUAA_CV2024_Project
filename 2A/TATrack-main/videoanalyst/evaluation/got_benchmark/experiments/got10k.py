...
class ExperimentGOT10k(object):
    ...
    def __init__(self,
                 ...
                 report_dir='reports',
                 use_dataset=True):
        self.color = {"pred":(0,255,0), "gt":(0,0,255)}  # 修改：添加
    ...
    def run(self,
        ...
        for s in loop:
            ...
            for r in range(self.repetitions):
                ...
                # record results
                self._record(record_file, boxes, times, verbose)
    ...
    def _record(self, record_file, boxes, times, verbose=False):
